    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_management.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sslc_certificate', models.ImageField(blank=True, null=True, upload_to='certificate')),
                ('additional_quaification', models.CharField(max_length=50)),
                ('additional_certificate', models.ImageField(blank=True, null=True, upload_to='certificate')),
